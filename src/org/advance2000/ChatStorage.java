...
public class ChatStorage {
	...
	private ChatStorage(Context c) {
	    context = c;
	    boolean useLinphoneStorage = c.getResources().getBoolean(org.linphone.R.bool.use_linphone_chat_storage);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(LinphoneService.instance());
		boolean updateNeeded = prefs.getBoolean(c.getString(org.linphone.R.string.pref_first_time_linphone_chat_storage), !LinphonePreferences.instance().isFirstLaunch());
