...
public class AboutFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View view = inflater.inflate(org.linphone.R.layout.about, container, false);

		TextView aboutText = (TextView) view.findViewById(org.linphone.R.id.AboutText);
		try {
			aboutText.setText(String.format(getString(org.linphone.R.string.about_text), getActivity().getPackageManager().getPackageInfo(getActivity().getPackageName(), 0).versionName));
		} catch (NameNotFoundException e) {
			Log.e(e, "cannot get version name");
		}

		sendLogButton = view.findViewById(org.linphone.R.id.send_log);
		sendLogButton.setOnClickListener(this);
		sendLogButton.setVisibility(LinphonePreferences.instance().isDebugEnabled() ? View.VISIBLE : View.GONE);

		resetLogButton = view.findViewById(org.linphone.R.id.reset_log);
		...
		exitButton = view.findViewById(org.linphone.R.id.exit);
