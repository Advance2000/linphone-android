...
import org.advance2000.setup.RemoteProvisioningActivity;
import org.advance2000.tutorials.TutorialLauncherActivity;
...
public class LinphoneLauncherActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Log(getResources().getString(org.linphone.R.string.app_name), !getResources().getBoolean(org.linphone.R.bool.disable_every_log));
		
		// Hack to avoid to draw twice LinphoneActivity on tablets
        if (getResources().getBoolean(org.linphone.R.bool.isTablet)) {
        	setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        } else {
        	setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        }
		setContentView(org.linphone.R.layout.launcher);
