...
public class AccountPreferencesFragment extends PreferencesListFragment {
	...
	public AccountPreferencesFragment() {
		super(org.linphone.R.xml.account_preferences);
	...
	private void initAccountPreferencesFields(PreferenceScreen parent) {
    	...
    	PreferenceCategory account = (PreferenceCategory) getPreferenceScreen().findPreference(getString(org.linphone.R.string.pref_sipaccount_key));
    	...
    	PreferenceCategory advanced = (PreferenceCategory) getPreferenceScreen().findPreference(getString(org.linphone.R.string.pref_advanced_key));
    	...
    	PreferenceCategory manage = (PreferenceCategory) getPreferenceScreen().findPreference(getString(org.linphone.R.string.pref_manage_key));
	...
	private void manageAccountPreferencesFields(PreferenceScreen parent) {
		...
		mProxyPreference.getEditText().setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_EMAIL_ADDRESS);
		mProxyPreference.setOnPreferenceChangeListener(proxyChangedListener);
		mProxyPreference.setSummary("".equals(mProxyPreference.getText()) || (mProxyPreference.getText() == null) ? getString(org.linphone.R.string.pref_help_proxy) : mProxyPreference.getText());
	...
	private void initializeTransportPreference(ListPreference pref) {
		...
		entries.add(getString(org.linphone.R.string.pref_transport_udp));
		values.add(getString(org.linphone.R.string.pref_transport_udp_key));
		entries.add(getString(org.linphone.R.string.pref_transport_tcp));
		values.add(getString(org.linphone.R.string.pref_transport_tcp_key));
		
		if (!getResources().getBoolean(org.linphone.R.bool.disable_all_security_features_for_markets)) {
			entries.add(getString(org.linphone.R.string.pref_transport_tls));
			values.add(getString(org.linphone.R.string.pref_transport_tls_key));
		}
		...
		if (! isNewAccount) {
			...
			pref.setSummary(getString(org.linphone.R.string.pref_transport_udp));
			pref.setDefaultValue(getString(org.linphone.R.string.pref_transport_udp));
			pref.setValueIndex(entries.indexOf(getString(org.linphone.R.string.pref_transport_udp)));
		}
	}
