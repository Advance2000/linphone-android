...
public class LinphonePreferences {
	...
	public void setAccountTransport(int n, String transport) {
		...
		if (proxyConfig != null && transport != null) {
			...
			try {
                ...
                int port = 0;
				if (transport.equals(getString(org.linphone.R.string.pref_transport_udp_key))) {
					proxyAddr.setTransport(TransportType.LinphoneTransportUdp);
				} else if (transport.equals(getString(org.linphone.R.string.pref_transport_tcp_key))) {
					proxyAddr.setTransport(TransportType.LinphoneTransportTcp);
				} else if (transport.equals(getString(org.linphone.R.string.pref_transport_tls_key))) {
	...
	public String getAccountTransportKey(int n) {
		...
		String key = getString(org.linphone.R.string.pref_transport_udp_key);

		if (transport != null && transport == TransportType.LinphoneTransportTcp)
			key = getString(org.linphone.R.string.pref_transport_tcp_key);
		else if (transport != null && transport == TransportType.LinphoneTransportTls)
			key = getString(org.linphone.R.string.pref_transport_tls_key);
	...
	public String getAccountTransportString(int n) {
		...
		if (transport != null && transport == TransportType.LinphoneTransportTcp)
			return getString(org.linphone.R.string.pref_transport_tcp);
		else if (transport != null && transport == TransportType.LinphoneTransportTls)
			return getString(org.linphone.R.string.pref_transport_tls);

		return getString(org.linphone.R.string.pref_transport_udp);
	}
	...
	public void setDebugEnabled(boolean enabled) {
		...
		LinphoneCoreFactory.instance().setDebugMode(enabled, getString(org.linphone.R.string.app_name));
	}
