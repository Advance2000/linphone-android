...
import org.advance2000.ui.LinphoneSliders;
import org.advance2000.ui.LinphoneSliders.LinphoneSliderTriggered;
...
public class IncomingCallActivity extends Activity implements LinphoneSliderTriggered {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(org.linphone.R.layout.incoming);

		mNameView = (TextView) findViewById(org.linphone.R.id.incoming_caller_name);
		mNumberView = (TextView) findViewById(org.linphone.R.id.incoming_caller_number);
		mPictureView = (AvatarWithShadow) findViewById(org.linphone.R.id.incoming_picture);
        ...
        mIncomingCallWidget = (LinphoneSliders) findViewById(org.linphone.R.id.sliding_widget);
	...
	protected void onResume() {
		...
		LinphoneUtils.setImagePictureFromUri(this, mPictureView.getView(), contact != null ? contact.getPhotoUri() : null,
				 contact != null ? contact.getThumbnailUri() : null, org.linphone.R.drawable.unknown_small);
	...
	private void answer() {
		...
		if (!LinphoneManager.getInstance().acceptCallWithParams(mCall, params)) {
			...
			Toast.makeText(this, org.linphone.R.string.couldnt_accept_call, Toast.LENGTH_LONG).show();
		} else {
