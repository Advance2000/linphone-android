...
public class ChatActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(org.linphone.R.layout.chat_activity);
		...
		getSupportFragmentManager().beginTransaction().add(org.linphone.R.id.fragmentContainer, fragment, "ChatFragment").commit();
		...
		if (chatFragment == null) {
			...
			fm.beginTransaction().add(org.linphone.R.id.fragmentContainer, chatFragment, CHAT_FRAGMENT).commit();
	    }
	}
}
