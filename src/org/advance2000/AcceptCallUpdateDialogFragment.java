...
public class AcceptCallUpdateDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(org.linphone.R.layout.accept_call_update_dialog, container);

        getDialog().setTitle(org.linphone.R.string.call_update_title);
        
        Button yes = (Button) view.findViewById(org.linphone.R.id.yes);
        ...
        Button no = (Button) view.findViewById(org.linphone.R.id.no);
