...
public class ContactsFragment extends Fragment implements OnClickListener, OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		mInflater = inflater;
        View view = inflater.inflate(org.linphone.R.layout.contacts_list, container, false);
        ...
        noSipContact = (TextView) view.findViewById(org.linphone.R.id.noSipContact);
        noContact = (TextView) view.findViewById(org.linphone.R.id.noContact);
        
        contactsList = (ListView) view.findViewById(org.linphone.R.id.contactsList);
        contactsList.setOnItemClickListener(this);
        
        allContacts = (TextView) view.findViewById(org.linphone.R.id.allContacts);
        allContacts.setOnClickListener(this);
        
        linphoneContacts = (TextView) view.findViewById(org.linphone.R.id.linphoneContacts);
        linphoneContacts.setOnClickListener(this);
        
        newContact = (TextView) view.findViewById(org.linphone.R.id.newContact);
		...
		clearSearchField = (ImageView) view.findViewById(org.linphone.R.id.clearSearchField);
		clearSearchField.setOnClickListener(this);
		
		searchField = (EditText) view.findViewById(org.linphone.R.id.searchField);
	...
	public void onClick(View v) {
		...
		if (id == org.linphone.R.id.allContacts) {
		...
		else if (id == org.linphone.R.id.linphoneContacts) {
		...
		else if (id == org.linphone.R.id.newContact) {
			editConsumed = true;
			LinphoneActivity.instance().addContact(null, sipAddressToAdd);
		} 
		else if (id == org.linphone.R.id.clearSearchField) {
			searchField.setText("");
		}
	}
	...
	class ContactsListAdapter extends BaseAdapter implements SectionIndexer {
		...
		ContactsListAdapter(List<Contact> contactsList, Cursor c) {
			...
			bitmapUnknown = BitmapFactory.decodeResource(LinphoneActivity.instance().getResources(), org.linphone.R.drawable.unknown_small);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				view = mInflater.inflate(org.linphone.R.layout.contact_cell, parent, false);
			}
			
			TextView name = (TextView) view.findViewById(org.linphone.R.id.name);
			name.setText(contact.getName());
			
			TextView separator = (TextView) view.findViewById(org.linphone.R.id.separator);
			LinearLayout layout = (LinearLayout) view.findViewById(org.linphone.R.id.layout);
			...
			ImageView icon = (ImageView) view.findViewById(org.linphone.R.id.icon);
			...
			ImageView friendStatus = (ImageView) view.findViewById(org.linphone.R.id.friendStatus);
			...
			if (!ContactsManager.getInstance().isContactPresenceDisabled() && friends != null) {
				...
				if (presenceActivity == PresenceActivityType.Online) {
					friendStatus.setImageResource(org.linphone.R.drawable.led_connected);
				} else if (presenceActivity == PresenceActivityType.Busy) {
					friendStatus.setImageResource(org.linphone.R.drawable.led_error);
				} else if (presenceActivity == PresenceActivityType.Away) {
					friendStatus.setImageResource(org.linphone.R.drawable.led_inprogress);
				} else if (presenceActivity == PresenceActivityType.Offline) {
					friendStatus.setImageResource(org.linphone.R.drawable.led_disconnected);
				} else {
					friendStatus.setImageResource(org.linphone.R.drawable.call_quality_indicator_0);
				}
			}
