...
public class HistoryFragment extends Fragment implements OnClickListener, OnChildClickListener, OnGroupClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		mInflater = inflater;
        View view = inflater.inflate(org.linphone.R.layout.history, container, false);
        ...
        historyList = (ExpandableListView) view.findViewById(org.linphone.R.id.historyList);
	...
	class CallHistoryAdapter extends BaseExpandableListAdapter {
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			if (convertView != null) {
				...
				view = mInflater.inflate(org.linphone.R.layout.history_cell, parent,false);
			}
			
			final LinphoneCallLog log = (LinphoneCallLog) getChild(groupPosition, childPosition);
			final LinphoneAddress address;
			
			TextView dateAndTime = (TextView) view.findViewById(org.linphone.R.id.dateAndTime);
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			if (convertView != null) {
				...
				view = mInflater.inflate(org.linphone.R.layout.history_group, parent,false);
			}
